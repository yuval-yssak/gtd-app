...
// NOTE: the former `restampOpenItemForStartDateChange` (conditional, only-if-untouched restamp on
// startDate PATCHes) is superseded by `routineEditPropagation.ts`'s unconditional schedule
